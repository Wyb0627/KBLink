...
parser.add_argument("--exp_name", help="experiment name", type=str, default="iswc")
...
if __name__ == '__main__':
    ...
    train_dataset = torch.load('./dataset/train_dataset_' + exp_name + '_' + args.LM)
    eval_dataset = torch.load('./dataset/eval_dataset_' + exp_name + '_' + args.LM)
    test_dataset = torch.load('./dataset/test_dataset_' + exp_name + '_' + args.LM)
